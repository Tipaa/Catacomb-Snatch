...
public class Console implements KeyListener {
	...
	if (open) {
	    ...
	    int consoleHeight = (MAX_LINES + 1) * fontHeight + yOffset; // +1
									...
									// input
									// line
	    s.alphaFill(0, 0, s.w, consoleHeight, 0xff000000, 0x80); // 50%
								     // Black.
								     // 0xblah
								     // is
								     // hexadecimal,
     ...
     */
    private Command help = new Command("help", 0,
	...
	public void doCommand(String[] args) {
	    ...
	    MojamComponent.instance.synchronizer
		    .addCommand(new com.mojang.mojam.network.PauseCommand(true));
	}
    };

    private Command exit = new Command("exit", 1,
	    "exits the game. 0 force exit, 1 regular game exit") {
	public void doCommand(String[] args) {
    ...
    private Command chat = new Command("chat", -1,
	    "Does the same as pressing T and typing in the after /chat and pressing enter") {
	public void doCommand(String[] args) {
	    String msg = "";
	    ...
	    MojamComponent.instance.synchronizer
		    .addCommand(new com.mojang.mojam.network.packet.ChatCommand(
			    msg));
	}
    };
	...
	@Override
	public void doCommand(String[] args) {
	    MojamComponent.instance
		    .handleAction(TitleMenu.RETURN_TO_TITLESCREEN);
	}
    };

    public Command allweapons = new Command("allweapons", 1,
	    "Gives all weapons") {
	@Override
	public void doCommand(String[] args) {
	    args[0].trim();
    ...
    public CommandGive give = new CommandGive("give", 1, "Gives a weapon",this) {
    ...
    Command cooldown = new Command("cool", 1,
	    "Cools the currently held weapon to a certain value") {
	@Override
	public void doCommand(String[] s) {
	    try {
